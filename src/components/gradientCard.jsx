...
const GradientCard = ({title ,image  ,link , ...props}) => {
  return (
   <div className={`${props.width ?props.width : "w-[40%]" } bg-gradient-to-t to-[#012E3600] from-[#012A48] flex flex-col `} >
    <div className="w-[90%] mx-auto flex flex-col justify-between items-center py-4 gap-6">

    <img src={image} alt="" className='max-h-[280px] min-h-[280px] max-w-[60%] min-w-[60%]' />
{title}
