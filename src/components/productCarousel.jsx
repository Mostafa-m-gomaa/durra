    ...
    >
        {productsItems?.length > 0 ?     <CarouselContent className="flex gap-4 px-4 w-full ">
            ...
            {productsItems?.map((sub , i) => {
                return (
                    <div key={i} className="flex flex-col gap-4 bg-[#1A1F23] min-w-[45%] max-w-[45%] lg:max-w-[25%] lg:min-w-[25%] p-2">
                      ...
                      <img src={sub?.imageCover || replaceImg } alt="" className='mx-auto'/>
