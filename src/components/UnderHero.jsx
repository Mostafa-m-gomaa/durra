...
<div className='w-[50%] mx-auto text-[28px] capitalize text-center py-28'>At durra, every piece is a symphony of meticulous craftsmanship and timeless allure, forged in precious metals and gemstones to transcend trends and become heirlooms of tomorrow.</div>
    </div>
    </div>
  )
}
